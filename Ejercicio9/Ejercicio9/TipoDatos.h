...
struct tipoDatos
{
	...
	int Eliminar(tipoDatos* fichas, int numeroFichas, int del);
	void Modificar(tipoDatos* fichas, int numeroFichas, char nombre[60], int del, long sizekb);
	void Organizar(tipoDatos* fichas, int numeroFichas);
};
